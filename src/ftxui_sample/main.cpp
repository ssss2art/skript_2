...
// configuration step. It creates a namespace called `skript_2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", skript_2::cmake::project_name, skript_2::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", skript_2::cmake::project_version);
      return EXIT_SUCCESS;
    }
